...
namespace Versiones4GL.Backend.Controllers
{
    public class XadsController : Controller
    {
        ...
        {
            return View(await db.Xads.ToListAsync());
        }
        ...
        public async Task<ActionResult> Create([Bind(Include = "MacserverId,Version")] Xad xad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "MacserverId,Version")] Xad xad)
        {
            if (ModelState.IsValid)
            {
