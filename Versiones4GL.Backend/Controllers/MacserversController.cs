...
namespace Versiones4GL.Backend.Controllers
{
    public class MacserversController : Controller
    {
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            Macserver macserver = await db.UserTypes.FindAsync(id);
            if (macserver == null)
            {
                return HttpNotFound();
            }
        ...
        public async Task<ActionResult> Create([Bind(Include = "MacserverId,Name")] Macserver macserver)
        {
            if (ModelState.IsValid)
            {
                db.UserTypes.Add(macserver);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "MacserverId,Name")] Macserver macserver)
        {
            if (ModelState.IsValid)
            {
