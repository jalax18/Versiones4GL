...
namespace Versiones4GL.Backend.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "UserId,FirstName,LastName,Province,Email,Telephone,ImagePath,UserTypeId")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "UserId,FirstName,LastName,Province,Email,Telephone,ImagePath,UserTypeId")] User user)
        {
            if (ModelState.IsValid)
            {
